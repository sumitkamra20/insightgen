...
from insightgen.openai_client import get_openai_client, generate_completion, generate_image_completion
...
def generate_observation_for_slide(
    ...
    try:
        ...
        observations_text, error = generate_image_completion(
...
def generate_headlines_sequential(
    ...
    for slide_number, slide in slide_data.items():
        ...
        try:
            ...
            headline, error = generate_completion(
                client,
                model,
                messages,
                temperature,
...
def generate_headlines(
    ...
    content_slides = sum(1 for slide in slide_metadata.values() if slide.get("content_slide", False))
    ...
    slide_metadata, obs_metrics = generate_observations_parallel(
    ...
    slide_metadata, headline_metrics = generate_headlines_sequential(
        slide_data=slide_metadata,
        ...
        context_window_size=context_window_size if context_window_size else 20
    )
